      ...
      <SafeAreaView style={SafeViewAndroid.AndroidSafeArea}>
         <View>
            <View className="flex-row justify-between py-5 ">
               <Text className="text-2xl font-bold text-cyan-700 self-center w-52">Welcome to <Text className="text-4xl">Deptest App</Text></Text>
               <TouchableOpacity className="w-10 h-10 shadow-sm flex items-center justify-center rounded-3xl self-center bg-cyan-600 border-cyan-900">
                  <HomeIcon className="shadow-md " color="#fff"/>
               </TouchableOpacity>
            </View>
            <View className="flex-row justify-around mb-5">
               <View className="flex items-center">
                  <TouchableOpacity className="w-36 h-36 bg-white shadow-md flex items-center justify-center rounded-lg">
                     <Image
